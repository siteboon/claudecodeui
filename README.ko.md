...
[Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Cursor CLI](https://docs.cursor.com/en/cli/overview), [Codex](https://developers.openai.com/codex), [Gemini-CLI](https://geminicli.com/) 및 [GitHub Copilot CLI](https://docs.github.com/en/copilot/using-github-copilot/using-github-copilot-in-the-command-line)를 위한 데스크톱 및 모바일 UI입니다. 로컬 또는 원격으로 사용하여 활성 프로젝트와 세션을 확인하고, 어디서든(모바일 또는 데스크톱) 변경할 수 있습니다.
...
<br>
<em>Claude Code, Cursor CLI, Codex, Gemini CLI, GitHub Copilot 중 선택</em>
</td>
</tr>
</table>
...
- **반응형 디자인** - 데스크톱, 태블릿, 모바일에서 원활하게 작동하여 모바일에서도 에이전트를 사용할 수 있습니다
- **대화형 채팅 인터페이스** - 에이전트와 원활하게 소통하는 내장 채팅 인터페이스
- **통합 셸 터미널** - 내장 셸 기능을 통한 에이전트 CLI 직접 접근
...
- **모델 호환성** - Claude, GPT, Gemini 모델 패밀리 지원 (전체 목록은 [`shared/modelConstants.js`](shared/modelConstants.js) 참조)
...
- [Codex](https://developers.openai.com/codex) 설치 및 구성, 그리고/또는
- [Gemini-CLI](https://geminicli.com/) 설치 및 구성, 그리고/또는
- [GitHub Copilot CLI](https://docs.github.com/en/copilot/using-github-copilot/using-github-copilot-in-the-command-line) 설치 및 구성
...
#### 프로젝트 관리
Claude Code, Cursor, Codex, Gemini, Copilot 세션을 사용할 수 있을 때 자동으로 발견하고 프로젝트로 그룹화합니다
- **프로젝트 작업** - 프로젝트 이름 변경, 삭제 및 정리
- **스마트 내비게이션** - 최근 프로젝트 및 세션에 빠르게 접근
- **MCP 지원** - UI를 통해 자체 MCP 서버 추가

#### 채팅 인터페이스
- **반응형 채팅 또는 CLI 사용** - 적응형 채팅 인터페이스를 사용하거나 셸 버튼을 사용하여 선택한 CLI에 연결할 수 있습니다
- **실시간 통신** - WebSocket 연결을 통해 선택한 CLI에서 응답 스트리밍
...
- **에이전트 통합 (Claude Code / Cursor CLI / Codex / Gemini CLI / GitHub Copilot CLI)** - 프로세스 생성 및 관리
...
<div align="center">
  <strong>Claude Code, Cursor, Codex, Gemini, Copilot 커뮤니티를 위해 정성껏 만들었습니다.</strong>
</div>
