...
function useSidebarHeaderController({
  isPWA,
  isMobile,
  isLoading,
  projectsCount,
  ...
  const runningBadgeText =
    runningSessionsCount > 99 ? "99+" : String(runningSessionsCount);

  return { showSearchTools, searchPlaceholder, runningBadgeText };
}
...
function renderSidebarHeader({
  ...
  searchPlaceholder,
  runningBadgeText,
}: SidebarHeaderProps & ReturnType<typeof useSidebarHeaderController>) {
  return (
        ...
        {showSearchTools && (
          <div className="mt-2.5 space-y-2">
            ...
            <div className="flex rounded-lg bg-muted/50 p-0.5">
              ...
              <Tooltip
                content={t("search.runningTooltip", "Running sessions")}
                position="top"
              >
                <button
                ...
                >
                  <span className="relative flex h-3 w-3 items-center justify-center">
                    <Activity
                      className={cn(
                        "h-3 w-3",
                        runningSessionsCount > 0 && "text-emerald-500",
                      )}
                    />
                    {runningSessionsCount > 0 && (
              ...
              <Tooltip
                content={t("search.archiveOnlyTooltip", "Archive only")}
                position="top"
              >
                <button
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="nav-search-input h-9 rounded-xl border-0 pl-9 pr-14 text-sm transition-colors duration-200 placeholder:text-muted-foreground/40 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              {searchFilter ? (
                <button
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-shrink-0 gap-1.5">
            <button
              className="flex h-8 w-8 items-center justify-center rounded-lg bg-muted/50 transition-transform active:scale-95"
              onClick={onRefresh}
              disabled={isRefreshing}
            >
              <RefreshCw
            ...
            <button
              className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/90 text-primary-foreground transition-transform active:scale-95"
              onClick={onCreateProject}
            >
          ...
          <div className="mt-2.5 space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={searchFilter}
                onChange={(event) => onSearchFilterChange(event.target.value)}
                className="nav-search-input h-10 rounded-xl border-0 pl-10 pr-9 text-sm transition-colors duration-200 placeholder:text-muted-foreground/40 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              {searchFilter && (
                <button
                  onClick={onClearSearchFilter}
...
export default function SidebarHeader({
  ...
  const controller = useSidebarHeaderController({
    isPWA,
    isMobile,
    isLoading,
    projectsCount,
