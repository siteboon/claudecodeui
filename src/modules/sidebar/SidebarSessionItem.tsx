...
function useSidebarSessionItemController({
  project,
  session,
  selectedSession,
  isProcessing,
  ...
  const compactSessionAge = formatCompactAge(
  ...
  const showRecentIndicator =
    !showAttentionIndicator && !isProcessing && sessionView.isActive;
...
function renderSidebarSessionItem({
  project,
  session,
  selectedSession,
  isProcessing,
  ...
  ReturnType<typeof useSidebarSessionItemController>) {
  return (
      ...
      {(showAttentionIndicator || showRecentIndicator) && (
        <div className="absolute left-0 top-1/2 -translate-x-1 -translate-y-1/2 transform">
          <Tooltip
            content={
              showAttentionIndicator
                ? t("tooltips.attentionRequiredIndicator", {
        ...
        <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isProcessing ? (
                    <span className="ml-auto flex-shrink-0">
                      <Tooltip
                        content={t(
                          "tooltips.processingSessionIndicator",
                          "Processing session",
                        )}
                        position="top"
                      >
          ...
          >
            ...
            >
              ...
              <div
                className="mx-auto mb-4 h-1 w-10 rounded-full bg-muted-foreground/30"
                aria-hidden="true"
              />
              ...
              <div className="mb-4 flex items-center gap-3 px-1">
                ...
                <div className="min-w-0">
                  ...
                  <p
                    id="mobile-session-options-description"
              ...
              {isEditing ? (
                <div className="mb-3 space-y-2">
                  <label
                    htmlFor={`mobile-session-rename-${session.id}`}
      ...
      {!isCompact && (
        <div>
          ...
          <div
            ...
            className="absolute right-2 top-1/2 flex -translate-y-1/2 transform items-center gap-1 opacity-100 transition-[transform,opacity] duration-200"
          >
            {isEditing ? (
              <>
                <input
              ...
              <ActionMenu
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    label: copyLabel,
                    description:
                      copyState === "error" ? "Click to try again." : undefined,
                    icon: CopyStateIcon,
...
function SidebarSessionItem({
  ...
  const controller = useSidebarSessionItemController({
    project,
    session,
    selectedSession,
    isProcessing,
  ...
  return renderSidebarSessionItem({
    project,
    session,
    selectedSession,
    isProcessing,
