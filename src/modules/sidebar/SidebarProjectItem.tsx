...
function useSidebarProjectItemController({
  project,
  selectedProject,
  selectedSession,
  isExpanded,
  ...
  const taskStatus: ReturnType<typeof getTaskIndicatorStatus> =
    getTaskIndicatorStatus(project, mcpServerStatus);
  ...
  useEffect(() => {
    ...
    const revealInput = () => {
      ...
      animationFrame = window.requestAnimationFrame(() => {
        mobileRenameInputRef.current?.scrollIntoView({
          block: "center",
          inline: "nearest",
        });
      });
...
function renderSidebarProjectItem({
  project,
  selectedProject,
  selectedSession,
  isExpanded,
  ...
  ReturnType<typeof useSidebarProjectItemController>) {
  return (
    <div
      className={cn(
        "md:space-y-1",
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div className="min-w-0 flex-1">
                    {isEditing ? (
                      <input
                        ...
                        className="w-full rounded-lg border-2 border-primary/40 bg-background px-3 py-2 text-sm text-foreground shadow-sm transition-[border-color,box-shadow] duration-200 focus:border-primary focus:shadow-md focus:outline-none"
                ...
                <div className="flex items-center gap-1">
                  {isEditing ? (
                    <>
                      <button
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-green-500 shadow-sm transition-[transform,box-shadow] duration-150 active:scale-90 active:shadow-none dark:bg-green-600"
                        onClick={(event) => {
                          event.stopPropagation();
                          saveProjectName();
                        }}
                      ...
                      <button
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-500 shadow-sm transition-[transform,box-shadow] duration-150 active:scale-90 active:shadow-none dark:bg-gray-600"
                        onClick={(event) => {
                          event.stopPropagation();
                          onCancelEditingProject();
                        }}
              ...
              {isEditing ? (
                ...
                <>
                  <div
                    role="button"
                    tabIndex={0}
                    className="touch:opacity-100 flex h-6 w-6 cursor-pointer items-center justify-center rounded opacity-0 transition-[opacity,background-color] duration-200 hover:bg-accent group-hover:opacity-100"
                    onClick={(event) => {
                      event.stopPropagation();
                      onStartEditingProject(project);
                    }}
                  ...
                  <div
                    role="button"
                    tabIndex={0}
                    className="touch:opacity-100 flex h-6 w-6 cursor-pointer items-center justify-center rounded opacity-0 transition-[opacity,background-color] duration-200 hover:bg-red-50 group-hover:opacity-100 dark:hover:bg-red-900/20"
                    onClick={(event) => {
                      event.stopPropagation();
                      onDeleteProject(project);
                    }}
...
function SidebarProjectItem({
  ...
  const controller = useSidebarProjectItemController({
    project,
    selectedProject,
    selectedSession,
    isExpanded,
  ...
  return renderSidebarProjectItem({
    project,
    selectedProject,
    selectedSession,
    isExpanded,
