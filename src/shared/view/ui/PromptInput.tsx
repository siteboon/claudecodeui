    ...
    return (
      <PromptInputContext.Provider value={contextValue}>
        <form
          ...
          className={cn(
            'relative overflow-hidden rounded-2xl border border-border bg-background shadow-float transition-shadow duration-200 focus-within:border-primary/30 focus-within:shadow-lg',
            className
          )}
          {...props}
        >
...
>(({ className, ...props }, ref) => (
  <textarea
    ...
    className={cn(
      'chat-input-placeholder block max-h-[40vh] w-full resize-none overflow-y-auto bg-transparent px-4 py-2 text-sm leading-6 text-foreground placeholder-muted-foreground focus:outline-none sm:max-h-[300px]',
      className
    )}
    {...props}
  />
