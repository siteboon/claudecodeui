...
const Onboarding = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    const isModalClosing =
      prevProvider !== null && activeLoginProvider === null;
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Configure your git identity to ensure proper attribution for
                your commits
              </p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {cursorAuthStatus.loading
                          ? "Checking..."
                          : cursorAuthStatus.authenticated
                            ? cursorAuthStatus.email || "Connected"
                            : "Not connected"}
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {codexAuthStatus.loading
                          ? "Checking..."
                          : codexAuthStatus.authenticated
                            ? codexAuthStatus.email || "Connected"
                            : "Not connected"}
                      </div>
                    </div>
                  </div>
