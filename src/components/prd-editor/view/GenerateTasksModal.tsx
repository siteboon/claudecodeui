        ...
        <div className="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t('generateTasksModal.title', 'Generate Tasks from PRD')}
            </h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4 p-6">
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-900/20">
            <h4 className="mb-2 font-semibold text-purple-900 dark:text-purple-100">
              {t('generateTasksModal.askClaudeTitle', 'Ask Claude Code directly')}
            </h4>
            <p className="mb-3 text-sm text-purple-800 dark:text-purple-200">
              {t('generateTasksModal.askClaudeDesc', 'Save this PRD, then ask Claude Code in chat to parse the file and create your initial tasks.')}
            </p>

            <div className="rounded border border-purple-200 bg-white p-3 dark:border-purple-700 dark:bg-gray-800">
              <p className="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">{t('generateTasksModal.examplePrompt', 'Example prompt')}</p>
              <p className="font-mono text-xs text-gray-900 dark:text-white">
                {t('generateTasksModal.examplePromptText', 'I have a PRD at .taskmaster/docs/{{fileName}}. Parse it and create the initial tasks.', { fileName })}
              </p>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4 text-center dark:border-gray-700">
            ...
            >
              {t('generateTasksModal.viewDocs', 'View TaskMaster documentation')}
            </a>
          </div>
          ...
          >
            {t('generateTasksModal.gotIt', 'Got it')}
          </button>
        </div>
      </div>
    </div>
