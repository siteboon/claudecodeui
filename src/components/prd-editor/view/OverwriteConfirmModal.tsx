      ...
      <div className="relative w-full max-w-md rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="p-6">
          <div className="mb-4 flex items-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('overwriteModal.title')}</h3>
          </div>

          <p className="mb-6 text-sm text-gray-600 dark:text-gray-400">
            {t('overwriteModal.description', { fileName })}
          </p>
          ...
          <div className="flex justify-end gap-3">
            ...
            >
              ...
              <span>{saving ? t('overwriteModal.saving') : t('overwriteModal.overwrite')}</span>
            </button>
          </div>
        </div>
      </div>
