import { Bell, Bot, FolderTree, GitBranch, Info, Key, ListChecks, Mic, MonitorPlay, Palette, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'files', labelKey: 'mainTabs.files', icon: FolderTree },
