...
export default function ChatMessagesPane({
  ...
  return (
    <div
      ...
      className={`chat-messages-pane relative h-full space-y-3 overflow-y-auto overflow-x-hidden px-0 py-3 mr-[33px] sm:space-y-4 sm:p-4 ${
        hasActivityIndicator ? 'pb-12 sm:pb-14' : ''
      }`}
    >
