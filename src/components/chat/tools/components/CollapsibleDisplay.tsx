      ...
      >
        ...
        {showRawParameters && rawContent && (
          <details className="relative mt-2 group/raw">
            <summary className="flex items-center gap-1.5 text-2xs text-gray-400 dark:text-gray-500 cursor-pointer hover:text-gray-600 dark:hover:text-gray-300 py-0.5">
              <svg
            ...
            <pre className="mt-1 text-2xs bg-gray-50 dark:bg-gray-900/50 border border-gray-200/40 dark:border-gray-700/40 p-2 rounded whitespace-pre-wrap break-words overflow-hidden text-gray-600 dark:text-gray-400 font-mono">
              {rawContent}
            </pre>
          </details>
        )}
