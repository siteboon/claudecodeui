...
const PROVIDER_SKILL_PATHS: Record<Exclude<SkillsProvider, 'opencode' | 'qoder'>, string> = {
...
export default function ProviderSkills({ selectedProvider, currentProjects }: ProviderSkillsProps) {
  ...
  const providerPath = (selectedProvider === 'opencode' || selectedProvider === 'qoder') ? null : PROVIDER_SKILL_PATHS[selectedProvider];
