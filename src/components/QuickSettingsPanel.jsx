    ...
    <>
      ...
      >
        <button
          ...
          aria-label={t(localIsOpen ? 'closeSettingsPanel' : 'openSettingsPanel')}
        >
          {localIsOpen ? (
        ...
        <div className="h-full flex flex-col">
          ...
          <div className={`flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-6 bg-white dark:bg-gray-900 ${isMobile ? 'pb-20' : ''}`}>
            ...
            <div className="space-y-2">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">{t('Appearance')}</h4>
            ...
            <div className="space-y-2">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">{t('toolDisplay')}</h4>
            ...
            {/* View Options */}
            <div className="space-y-2">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">{t('viewOptions')}</h4>
            ...
            {/* Input Settings */}
            <div className="space-y-2">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">{t('inputSettings')}</h4>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 ml-3">
                {t('sendByCtrlEnterHelp')}
              </p>
            </div>

            {/* Whisper Dictation Settings - HIDDEN */}
            <div className="space-y-2" style={{ display: 'none' }}>
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">{t('whisperDictation')}</h4>
