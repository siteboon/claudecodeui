        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-full max-w-md mx-4 p-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{t('common:app.updateAvailable.title')}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">{t('common:app.updateAvailable.subtitle')}</p>
              </div>
            </div>
            <button
              onClick={() => setShowVersionModal(false)}
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('common:app.updateAvailable.currentVersion')}</span>
              <span className="text-sm text-gray-900 dark:text-white font-mono">{currentVersion}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
              <span className="text-sm font-medium text-blue-700 dark:text-blue-300">{t('common:app.updateAvailable.latestVersion')}</span>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-medium text-gray-900 dark:text-white">{t('common:app.updateAvailable.howToUpgrade')}</h3>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              {t('common:app.updateAvailable.upgradeInstructions')}
            </p>
          </div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            >
              {t('common:app.updateAvailable.later')}
            </button>
            <button
              onClick={() => {
            ...
            >
              {t('common:app.updateAvailable.copyCommand')}
            </button>
          </div>
        </div>
      </div>
