...
export const OPENCODE_PREDEFINED_MODELS: ProviderModelsDefinition = {
  OPTIONS: [
    ...
    { value: 'openrouter/deepseek/deepseek-v4-pro', label: 'DeepSeek V4 Pro', description: 'OpenRouter' },
    { value: 'openrouter/deepseek/deepseek-v4-flash', label: 'DeepSeek V4 Flash', description: 'OpenRouter' },
    { value: 'openrouter/qwen/qwen3.7-max', label: 'Qwen3.7 Max', description: 'OpenRouter' },
    { value: 'openrouter/qwen/qwen3.7-plus', label: 'Qwen3.7 Plus', description: 'OpenRouter' },
    { value: 'openrouter/moonshotai/kimi-k3', label: 'Kimi K3', description: 'OpenRouter' },
