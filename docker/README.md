...
| `CLAUDE_TOOL_APPROVAL_TIMEOUT_MS` | `55000` | How long a Claude tool permission prompt waits for an answer before the tool is denied (ms, plain integer, max `2147483647`). `0` disables the timeout |
